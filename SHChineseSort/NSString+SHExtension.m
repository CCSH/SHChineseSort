...
- (NSString *)getTimeWithCurrentFormat:(NSString *)currentFormat format:(NSString *)format{
    ...
    //变成毫秒
    NSString *temp = [self getMsTimeWithFormat:currentFormat];

    return [temp getTimeMsWithFormat:format];
}
...
- (NSString *)getMsTimeWithFormat:(NSString *)format{
    ...
    return [self getMsTimeWithFormat:format GMT:[self getCurrentGMT]];
}
...
- (NSString *)getTimeMsWithFormat:(NSString *)format{
    ...
    return [self getTimeMsWithFormat:format GMT:[self getCurrentGMT]];
}
